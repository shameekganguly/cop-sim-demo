...
const string world_fname = "resources/05-one-box/world.urdf";
const string object_fname = "resources/05-one-box/box_object.urdf";
const string object1_name = "Box1";
const double box_xlength = 0.2;
const double box_ylength = 0.4;
...
int main(int argc, char** argv) {
    ...
    cop_sim->addBoxObject(object1_name, object_link_name, "box1", coobject1, box_xlength, box_ylength, box_zlength);
    // add plane
